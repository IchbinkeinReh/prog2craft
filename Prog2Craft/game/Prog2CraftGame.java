...
public class Prog2CraftGame {
	...
	public Prog2CraftGame(GameContainer gc, Mode mode) throws SlickException {
	 ...
	 setMap(Map.parse("MMMMMMMMMMMMMMMMMMMMMMMMMMMMMM",
				 	  "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMM",
					  "MMGGGGGGGGGGGGGGGGGGGGGGGGGGMM",
					  "MMGGGGGFFFFFFFFFFFFFFFFGGGGGMM",
					  "MMGGFFFFFFLLLLLLLLLLFFFFFFGGMM",
					  "MMGGFFLLLLLLLLLLLLLLLLLLFFGGMM",
					  "MMGGFFLLLLLLLLLLLLLLLLLLFFGGMM",
					  "MMGGFFLLLLLLLLLLLLLLLLLLFFGGMM",
					  "MMGFFLLLLLLLLLLLLLLLLLLLLFFGMM",
					  "MMGFFLLLLLLLLLLLLLLLLLLLLFFGMM",
					  "MMGGFFLLLLLLLLLLLLLLLLLLFFGGMM",
					  "MMGGFFLLLLLLLLLLLLLLLLLLFFGGMM",
					  "MMGGFFLLLLLLLLLLLLLLLLLLFFGGMM",
