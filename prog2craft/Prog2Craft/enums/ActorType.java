...
public enum ActorType {
    ZIVILIST("data/ziv.png", 1, 0, 0, 0, 1, LEER, FELSIG), HEALER("data/heal.png", 10, 2, 10, -15, 15, LEER, FELSIG), INFANTARIE("data/inf.png", 10, 5, 5, 5,
	    5, LEER, FELSIG, GEBIRGE), PANZER("data/panzer.png", 20, 10, 10, 10, 10, LEER), LAUFPANZER("data/laufpanzer.png", 30, 15, 15, 15, 15, LEER, FELSIG), FLUGZEUG(
	    "data/flugzeug.png", 50, 25, 25, 25, 25, LEER, FELSIG, GEBIRGE, MEER), CHUCKNORRIS("data/chucknorris.png", 1000, 1000, 1000, 1000, 1000, LEER,
	    FELSIG, GEBIRGE, MEER);
